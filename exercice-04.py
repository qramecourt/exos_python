...
print(number)
if number == 1:
    print('le nombre tiré est égal à 1')
else: 
    print('le nombre tiré n\'est pas égal à 1')
# code 4.2
...
# réponse 4.2
if number % 2 == 0:
    print('le nombre itré est pair')
else: 
    print('le nombre tiré est impair')
# exo 4.3
# Écrivez un bloc if qui affiche
...
# réponse 4.3
if number % 3 != 0:
    print('le nombre tiré n\'est pas divisible par 3')
else:
    print('le nombre tiré est divisible par 3')
# exo 4.4
# écrivez un bloc if qui affiche
...
# réponse 4.4
if number >= 5: 
    print('le nombre tiré est supérieur ou égal à 5')
# exo 4.5
# écrivez un bloc if qui affiche
...
# réponse 4.6
if number < 34:
    print('le chiffre tiré est compris entre 0 et 33 inclus')
elif 34 < number < 67:
    print('le chiffre tiré est compris entre 34 et 66 inclus')
else:
